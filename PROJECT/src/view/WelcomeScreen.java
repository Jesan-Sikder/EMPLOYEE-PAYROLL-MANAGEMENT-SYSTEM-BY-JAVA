...
//     ImageIcon userPic = new ImageIcon(getClass().getResource("/view/jesan.jpg"));
...
public class WelcomeScreen extends JPanel {
    public WelcomeScreen(ActionListener adminListener, ActionListener employeeListener) {
        ...
        btnCreator.addActionListener(e -> {
            ...
            mainPanel.setLayout(new BoxLayout(mainPanel, BoxLayout.Y_AXIS));
            mainPanel.setBorder(BorderFactory.createEmptyBorder(20, 30, 20, 30));
System.out.println("Resource found: " + getClass().getResource("/view/jesan.JPG"));
            // LOAD YOUR PHOTO HERE (with null check)
            JLabel picLabel;
            URL imgUrl = getClass().getResource("/view/jesan.JPG");
            if (imgUrl != null) {
