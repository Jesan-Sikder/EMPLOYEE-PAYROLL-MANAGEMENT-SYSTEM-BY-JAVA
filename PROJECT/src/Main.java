...
//     //             showPanel("employeeDashboard");
//     //         }
//     //         // Add handlers for btnProfile, btnSettings, btnSupport if you want
//     //     }
//     // };
//     private static ActionListener empListener = new ActionListener() {
//     @Override
...
//                 // (Optional) Here you could actually send an email if you implement EmailService
//             }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            empLoginPanel = new LoginPanel("Employee Login", e -> {
                ...
                if (emp != null) {
                    currentEmployee = emp;
                    // Remove old dashboard if present to avoid duplicate cards
